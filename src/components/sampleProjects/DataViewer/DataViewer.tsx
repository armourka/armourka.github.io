...
export const DataViewer: React.FC = () => {
  ...
  return (
    <>
      ...
      <Box sx={{ display: 'flex', flexDirection: 'row', padding: 2, justifyContent: 'space-evenly', textAlign: 'center' }}>
        ...
        <Card variant="outlined" sx={{ width: '30%' }}>
          <CardContent>
            ...
            <Box sx={{ margin: 'auto' }}>
              <img width="100px" alt="React-icon" src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/React-icon.svg/512px-React-icon.svg.png?20220125121207" />
        ...
        <Card variant="outlined" sx={{ width: '30%' }}>
          <CardContent>
            <Typography variant="subtitle1">Average Recommendation Score</Typography>
