  ...
  return (
    <Page>
      ...
      <Box sx={{ margin: 'auto', marginTop: '20px', width: '75%' }}>
        <Typography>
          These front-end demo pages are intended to give you an idea of what I can build to support your business needs.
          Don't limit your expectations - this is only a small sample of what I can offer!
        </Typography>
